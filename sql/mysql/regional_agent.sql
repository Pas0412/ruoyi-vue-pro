...
CREATE TABLE `product_regional_agent` (
  ...
  `brokerage_price` decimal(10,1) NOT NULL DEFAULT '0.0' COMMENT '可用佣金，单位：元',
  `frozen_brokerage_price` decimal(10,1) NOT NULL DEFAULT '0.0' COMMENT '冻结佣金，单位：元',
...
CREATE TABLE `product_regional_agent_record` (
  ...
  `price` decimal(10,1) NOT NULL COMMENT '金额，单位：元',
  `total_price` decimal(10,1) NOT NULL COMMENT '当前总佣金，单位：元',
...
CREATE TABLE `product_regional_agent_withdraw` (
  ...
  `tenant_id` bigint NOT NULL DEFAULT 1 COMMENT '租户编号',
  `user_id` bigint NOT NULL COMMENT '用户编号',
  `price` decimal(10,1) NOT NULL COMMENT '提现金额，单位：元',
  `fee_price` decimal(10,1) NOT NULL DEFAULT '0.0' COMMENT '手续费，单位：元',
  `total_price` decimal(10,1) NOT NULL COMMENT '总佣金，单位：元',
