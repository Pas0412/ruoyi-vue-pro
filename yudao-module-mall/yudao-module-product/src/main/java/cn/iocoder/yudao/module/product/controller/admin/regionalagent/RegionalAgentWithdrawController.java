...
public class RegionalAgentWithdrawController {
    ...
    public CommonResult<Long> createRegionalAgentWithdraw(@Valid @RequestBody RegionalAgentWithdrawCreateReqVO createReqVO) {
        return success(regionalAgentWithdrawService.createRegionalAgentWithdraw(getLoginUserId(), RegionalAgentWithdrawConvert.INSTANCE.convert(createReqVO)));
    }
    ...
    public CommonResult<Boolean> approveRegionalAgentWithdraw(@Valid @RequestBody RegionalAgentWithdrawApproveReqVO approveReqVO) {
        regionalAgentWithdrawService.auditRegionalAgentWithdraw(approveReqVO.getId(), approveReqVO.getStatus(), approveReqVO.getAuditReason());
        return success(true);
    }
